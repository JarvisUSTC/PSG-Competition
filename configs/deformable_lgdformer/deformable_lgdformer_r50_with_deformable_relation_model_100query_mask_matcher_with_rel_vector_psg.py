_base_ = [
    './deformable_lgdformer_r50_with_deformable_relation_model.py', '../_base_/datasets/psg.py',
...
expt_name = 'deformable_lgdformer_r50_psg_with_deformable_rel_model_100_mask_matcher_focal_loss_with_rel_vector'
entity = 'psgyyds'
