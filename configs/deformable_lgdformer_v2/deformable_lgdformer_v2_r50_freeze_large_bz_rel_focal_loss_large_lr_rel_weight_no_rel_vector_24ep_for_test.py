_base_ = [
    './deformable_lgdformer_v2_r50.py', '../_base_/datasets/psg_test.py',
...
expt_name = 'deformable_lgdformer_v2_r50_freeze_bz_10_rel_focal_loss_2e-4_rel_weightx2_no_rel_vector_supervision_24eps'
entity = 'psgyyds'
