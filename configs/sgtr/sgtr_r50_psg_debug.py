_base_ = [
    './sgtr_r50.py', '../_base_/datasets/psg.py',
...
custom_imports = dict(imports=[
    ...
    'openpsg.models.relation_heads.entities_indexing_head',
    'openpsg.models.relation_heads.sgtr_head',
    'openpsg.datasets',
...
# load_from = './checkpoints/detr4sgtr_r50.pth'
load_from = '/mnt/v-jiaweiwang/Checkpoints/OpenPSG/SGTR/pth_2022_9_4.pth'
